...
exports.calculateChurnProbability = calculateChurnProbability;
const uuid_1 = require("uuid");
function calculateChurnProbability(customer, recentMetrics) {
...
function extractFeatures(customer, metrics) {
...
function calculateContributingFactors(features) {
    const factors = {};
...
function estimateDaysToChurn(churnProbability, features) {
