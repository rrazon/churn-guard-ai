...
function createDemoCustomers() {
  ...
  for (let i = 0; i < 492; i++) {
    ...
    if (healthScore >= 80) churnRiskLevel = 'low';
    else if (healthScore >= 50) churnRiskLevel = 'medium';
    else if (healthScore >= 20) churnRiskLevel = 'high';
    else churnRiskLevel = 'critical';
